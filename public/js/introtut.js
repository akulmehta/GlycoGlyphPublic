const tutorialsteps = [
  ...
  {
    "id": "getGTCIDBtn",
    "html": `You can request for the GlyTouCan ID for the structure by clicking this button. It will fetch the GlyTouCan IDs for all possible reducing end anomers, i.e. alpha, beta, unkown and open ring. In addition, GlycoGlyph will search GlyGen and retrieve information for other databases.`,
    "placement": "right"
  },
  {
    "id" : "clearDrawingAreaColumn",
    "html": `To clear the drawing area at any time, click this button.`,
    "placement": "left"
  },
  {
    "id": "settingscolumn",
