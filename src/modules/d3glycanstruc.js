import { drawingSettings, filePaths, dynamicDrawingSettings } from "./globalvars.js";
import { glycantojson } from "./glycantoJSON.js";
import { sortchildren } from "./sortchildren.js";
import { addmono } from './addmono.js';
import { replacemono } from './replacemono.js';
import { deletemono } from './deletemono.js';


//Draws the structure
export function d3glycanstructure(glycanname, options) {
